    ...
    <>
      ...
      {flows.map((flow) => (
        <div key={flow.sessionId} className="grid grid-cols-9 px-6">
          ...
          <span className="pt-2 pb-2 pr-2 text-xs text-gray-900 font-code bg-blue-50 text-right">{flow.sessionId}</span>
          <span className="pt-2 pb-2 pr-2 text-xs text-gray-900 font-code text-right">{flow.streamId}</span>
          <span className="pt-2 pb-2 pr-2 text-xs text-gray-900 font-code bg-blue-50 text-right">{flow.pubPositionSampled}</span>
          <span className="pt-2 pb-2 pr-2 text-xs text-gray-900 font-code text-right">{flow.subPosition}</span>
          <span className="pt-2 pb-2 pr-2 text-xs text-gray-900 font-code bg-blue-50 text-right">{flow.diff}</span>
          <span className="pt-2 pb-2 pr-2 text-xs text-gray-900 font-code text-right">{flow.sendBackPressureEvents}</span>
        </div>
      ))}

...
const Header: React.FC = () => {
  return (
      <Disclosure as="nav" className="bg-white w-full shadow-lg">
        {({ open }) => (
          <>
                ...
                <div className="flex items-center px-2 lg:px-0">
                  ...
                  <div className="hidden lg:block lg:ml-6">
                    <div className="flex space-x-4">
                      ...
                      <a href="/articles" className="text-gray-700 hover:bg-shaunnew-500 hover:text-white px-3 py-2 rounded-md text-base font-text">
                        Articles
                      </a>
                      <a
                        href="/notes"
                        className="text-gray-700 hover:bg-shaunother-100 hover:text-white px-3 py-2 rounded-md text-base font-text"
                      >
                        Notes
                      </a>
                      <a
                        href="/aeroncookbook"
                        className="text-gray-700 hover:bg-shaunother-200 hover:text-white px-3 py-2 rounded-md text-base font-text"
                      >
                        Aeron Cookbook
                      </a>
                      <a
                        href="/about"
                        className="text-gray-700 hover:bg-shaunother-400 hover:text-white px-3 py-2 rounded-md text-base font-text"
                      >
                        About
                      </a>
                    </div>
            ...
            <Disclosure.Panel className="lg:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1">
                {/* Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" */}
                <a href="/articles" className="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-text">
                  Articles
                </a>
                <a
                  href="/notes"
                  className="text-gray-500 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-text"
                >
                  Notes
                </a>
                <a

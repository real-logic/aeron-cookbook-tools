  ...
  return (
    <>
      ...
      <div className="grid grid-cols-9 px-6 bg-yellow-50">
        <span className="pt-1 pr-2 text-xs text-gray-500 font-bold col-span-3 break-all">
          Channel
        </span>
      ...
      {flows.map((flow) => (
        <div key={flow.sessionId} className="grid grid-cols-9 px-6">
          <span className="pt-2 pb-2 pr-2 text-xs text-gray-900  col-span-3 break-all font-code">
            <AeronStatChannelDisplay channelData={flow.channelParsed} />
          </span>

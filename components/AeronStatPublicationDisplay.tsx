  ...
  return (
    <>
      ...
      <div className="grid grid-cols-9 px-6 bg-yellow-50">
        ...
        <span className="pt-1 pr-2 text-xs text-gray-500 bg-blue-50 font-bold text-right">Send Back Pressure</span>
        <span className="pt-1 pr-2 text-xs text-gray-500 font-bold text-right">Pub Pos (Sampled)</span>
        <span className="pt-1 pr-2 text-xs text-gray-500 bg-blue-50 font-bold text-right">Pub Lmt</span>
        <span className="pt-1 pr-2 text-xs text-gray-500 font-bold text-right">Send Pos</span>
        <span className="pt-1 pr-2 text-xs text-gray-500 bg-blue-50 font-bold text-right">Send Lmt</span>
      </div>

                      ...
                      <div className="relative w-auto my-6 mx-auto max-w-3xl">
                        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                          ...
                          <p className="dark:text-white font-ui mt-4 mb-4 w-full text-lg max-w-screen-lg leading-8">
                            ...
                            <br/>
                            <br/>
                            <span className="font-semibold font-italic">Data is processed in the browser and is never sent server side. There are no cookies and no tracking of any kind.</span><span> This can be confirmed via the <a className="underline text-blue-500" target="_blank" rel="noreferrer" href="https://github.com/eleventy7/acb-tools">source code</a>, which is open source. This is built off of commit <span className="font-code">{process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA}.</span><br/><br/> See also: <a href="https://www.aeroncookbook.com"  target="_blank" rel="noreferrer" className="underline text-blue-500 font-medium">Aeron Cookbook</a></span>
                          </p>
                          </div>
